...
- Feature barrels using `part of`: `lib/features/search/search.dart`, `lib/features/bookmarks/bookmarks.dart`, `lib/features/quiz/quiz.dart`, `lib/features/settings/settings.dart`.
...
- Bookmarks/quiz history bypass repository and call `DBHelper` static methods directly from UI/BLoC (example: `BookmarksBloc`, `ResultsTab`, `_SearchBottomSheetScreen`).
